...
// -------------------------- STATIC METHODS --------------------------
    ...
    private static void onMakeInsertDirtyFailed() {
        ...
        if (BuildConfig.DEBUG) {
            Log.w("WrappedLayoutManager", "Can't make LayoutParams insets dirty, decorations measurements might be incorrect");
        }
    }
...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    @SuppressWarnings("UnusedDeclaration")
    public WrappedLayoutManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public WrappedLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
...
// -------------------------- OTHER METHODS --------------------------
    ...
    private void logMeasureWarning(int child) {
        if (BuildConfig.DEBUG) {
            Log.w("WrappedLayoutManager", "Can't measure child #" + child + ", previously used dimensions will be reused." +
    ...
    private void measureChild(RecyclerView.Recycler recycler, int position, int widthSize, int heightSize, int[] dimensions) {
        ...
        try {
            ...
            if (BuildConfig.DEBUG) {
                Log.w("WrappedLayoutManager", "WrappedLayoutManager doesn't work well with animations. Consider switching them off", e);
            }
            return;
        }
